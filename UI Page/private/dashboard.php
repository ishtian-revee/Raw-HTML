        ...
        <table noshade="noshade" width="1000" align="center" cellpadding="5">
          <tr>
            ...
            <td width="35" align="center" valign="center">
              <a href="../private/view_profile.php">
              ...
              <table border="1" width="1000" cellpadding="10">
                <tr height="585">
                  <td width="250" valign="top">
                    ...
                    <ul>
                      <li><a href="../private/dashboard.php"><h4><font face="calibri" color="#444444">Dashboard</font></h4></a></li>
                  ...
                  <td width="750" valign="top"><br><br>
                    <h1><font face="calibri" color="#444444"><?php echo "Welcome {$_SESSION['username']}"; ?></font></h1></td>
                  </td>
                </tr>
              </table>
            </td>
